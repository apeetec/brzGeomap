...
?>
	<style>
		.empreendimentos-template-default .tabs-container .tab.active{background-color:<?php echo $cor;?>;}
	</style>
<!-- Painel single -->
	<article class="painel-single container">
		<section class="banner">
			<img src="<?php echo $capa;?>" alt="Capa do empreendimento <?php echo $titulo;?>">
		</section>
		<div class="row no-gap">
			<div class="col s12 m12 l2 box-logo-main" style="background-color:<?php echo $cor; ?>;">
...
<!-- Modal Plantas -->
<?php		
if(!empty($implantacao) || !empty($espec_implantacao) || !empty($grupo_plantas) || !empty($texto_legal_implantacao)){
